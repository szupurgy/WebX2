...
const AllProducts = () => {
    ...
    window.onload = function() {
        const termekContainer = document.getElementById('alltermek');
        for (let i = 0; i < termekek.length; i++) {
            termekContainer.innerHTML += `<div className='flex rounded-md w-5/6 border p-2'>
            <div className=''>
            ...
            <div className='flex flex-col p-2 justify-center items-center'>
                <h1 className='text-2xl'>${termekek[i].nev}</h1>
                <h2 className='text-xl'>${termekek[i].ar}Ft</h2>
